...
- **O** -- Object
- **I** -- Item
- **IR** -- Itemreq, see quests-itemreq-vanillaplus

---

## `db/`

### `quests-vanillaplus.lua`
...
[QUESTID#] = {
    ...
    ["obj"] = {  -- Quest objectives
        ...
        ["IR"] = { item_req_ids },       -- see quests-itemreq-vanillaplus.lua
    },
}
```
